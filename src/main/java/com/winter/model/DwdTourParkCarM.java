...
/**
 * @name DwdTourParkCarM
 * @Description DwdTourParkCarM实体对象
 * @author tujing
 * @date 2016-07-01
 */
@Alias("DwdTourParkCarM")
public class DwdTourParkCarM  {

	private static final long serialVersionUID = 1L;
	/**
	 * @name code @Length(max=6)
	 */
	private String code;
	/**
	 * @name 总车量
