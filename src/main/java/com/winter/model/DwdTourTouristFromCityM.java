...
/**
 * @name DwdTourTouristFromCityM
 * @Description DwdTourTouristFromCityM实体对象
 * @author tujing
 * @date 2016-07-01
 */
@Alias("DwdTourTouristFromCityM")
public class DwdTourTouristFromCityM  {
	 ...
	 * @name 无参构造函数
	 */
	public DwdTourTouristFromCityM() {
